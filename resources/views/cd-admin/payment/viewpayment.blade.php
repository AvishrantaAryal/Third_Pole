      ...
      <div class="col-xs-12">
         <div class="box">
          <div class="box-header">
            <h3 class="box-title">
               <a href="{{url('/payment-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Payment</button></a>
            </h3>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
             ...
             <a href="{{url('/deletepayment/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <form role="form" action= "{{url('/updatepayment/'.$t->id)}}" enctype="multipart/form-data" method="post">
        {{csrf_field()}}
