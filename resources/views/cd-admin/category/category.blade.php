      ...
      <div class="col-xs-12">
         <div class="box">
          <div class="box-header">
            <h3 class="box-title">
               <a href="{{url('/category-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Category</button></a>
            </h3>
          ...
          <div class="box-body">
            ...
            <table id="example1" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <td>{{$pa->name}}</td>
                <td height = "75px">
                    <form action="{{url('/categorystatus/'.$pa->id)}}" method="POST">
                      {{csrf_field()}}
                    <div class="btn-group">
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <div class="modal-body">
      ...
      <strong>Category Name:</strong> {!!$t->name!!}</p> 
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
             ...
             <a href="{{url('/deletecategory/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <form role="form" action= "{{url('/updatecategory/'.$t->id)}}" enctype="multipart/form-data" method="post">
        {{csrf_field()}}
          ...
          <div class="form-group">
              <label for="exampleInputFile">Image for Category</label>
              ...
              <input type="text" class="form-control" name="alt" id="alt"  value="{{$t->alt}}">
          </div>
      ...
      <div class="text text-danger">{{$errors->first('status')}}</div>
            ...
            <label>
                <input type="radio" class="minimal" <?php echo $t['status'] == 'inactive' ? 'checked' :  '' ?> checked name="status" value="inactive">Inctive
            </label>
