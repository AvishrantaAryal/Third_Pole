...
<div class="row">
  <div class="col-md-12 box1">
    <div class="box box-default">
      ...
      <div class="box-body">
        <!-- Date dd/mm/yyyy -->
        <form role="form" method="post" action= "{{url('storecategory')}}" enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="form-group">
                <label for="name">Category Name</label>
                <div class="text text-danger">{{$errors->first('name')}}</div>
                <input type="text" class="form-control" name="name"  id="name" placeholder="Enter Category Name" value="{{Request::old('name')}}">
        ...
        <div class="text text-danger">{{$errors->first('status')}}</div>
            ...
            <button class="btn btn-success pull-right " type="submit">Add Category</button>
