...
<div class="content-wrapper">
  ...
  <section class="content-header">
   ...
   <ol class="breadcrumb">
        ...
        <li><a href="#">Delivary And Shipment</a></li>
        <li class="active">View Delivary And Shipment</li>
      </ol>
      ...
      <div class="col-xs-12">
         <div class="box">
          <div class="box-header">
            <h3 class="box-title">
               <a href="{{url('/delivary-add')}}"><button class="btn btn-success" style="margin-bottom: 10px; ">Add Delivary And Shipment</button></a>
            </h3>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
             ...
             <a href="{{url('/deletedelivary/'.$t->id)}}"> <button type="button" class="btn btn-outline">Yes</button></a>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
...
<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-body">
    <form role="form" action= "{{url('/updatedelivary/'.$t->id)}}" enctype="multipart/form-data" method="post">
        {{csrf_field()}}
